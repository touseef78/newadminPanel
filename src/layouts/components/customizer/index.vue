<template>
  <!-- <div :class="`hp-theme-customizer${activeClass ? ' active' : ''}`">
    ...
    <div class="hp-theme-customizer-container bg-black-0 hp-bg-dark-90">
      <div
        class="hp-theme-customizer-container-header bg-black-10 hp-bg-dark-85 py-16 px-24"
      >
        <div class="d-flex justify-content-between">
          <div>
            <span class="h5 mb-0 d-block text-black-80 hp-text-color-dark-0">
              Customise your YODA
            </span>
            <span class="hp-caption font-weight-medium d-block text-black-60">
          ...
          <div>
            ...
            >
              <i
                class="ri-close-fill text-black-80 hp-text-color-dark-0"
      ...
      <div
        class="hp-theme-customizer-container-body pb-md-96 pb-mb-0 py-24 px-24"
      >
        <b-row class="mx-0 hp-theme-customizer-container-body-item">
          <b-col cols="12" class="px-0 mb-16">
            <span class="d-block hp-caption text-black-60">THEME</span>
            <span class="d-block h5 mb-0 text-black-100 hp-text-color-dark-0">
              Dark &amp; Light
            </span>
          </b-col>
          ...
          <b-col cols="12" class="px-0">
            <b-row>
              <b-col cols="12" md="6">
                <div
                  :class="`hp-theme-customizer-container-body-item-svg${
                    theme == 'light' ? ' active' : ''
                  }`"
                ...
                >
                  ...
                  <div
                    class="hp-theme-customizer-container-body-item-svg-check"
                  >
                    <svg
                      width="34"
                      height="34"
              ...
              <b-col cols="12" md="6" class="mt-24 mt-md-0">
                <div
                  :class="`hp-theme-customizer-container-body-item-svg${
                    theme == 'dark' ? ' active' : ''
                  }`"
        ...
        <b-row class="mx-0 hp-theme-customizer-container-body-item">
          <b-col cols="12" class="mb-16 px-0">
            <span class="d-block hp-caption text-black-60">
              LAYOUT DIRECTION
            </span>
            <span class="d-block h5 mb-0 text-black-100 hp-text-color-dark-0">
              LTR & RTL
                ...
                >
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="#B2BEC3"
                    ></path>
                    <rect width="244" height="150" stroke="#2D3436"></rect>
                    <defs>
          ...
          <b-col cols="12" class="px-0">
            <b-row>
              <b-col cols="12" md="6">
                <div
                  :class="`hp-theme-customizer-container-body-item-svg${
                    contentWidth == 'full' ? ' active' : ''
                  }`"
                  @click="contentWidthChange('full')"
                >
                  <svg
                    width="244"
                    height="150"
              ...
              <b-col cols="12" md="6" class="mt-24 mt-md-0">
                <div
                  :class="`hp-theme-customizer-container-body-item-svg${
                    contentWidth == 'boxed' ? ' active' : ''
                  }`"
                  @click="contentWidthChange('boxed')"
                >
                  <svg
                    width="244"
                    height="150"
          ...
          <b-col cols="12" class="px-0">
            <b-row>
              <b-col cols="12" md="6">
                <div
                  :class="`hp-theme-customizer-container-body-item-svg${
                    vertical || verticalMini || !verticalCollapsed
                      ? ' active'
                      : ''
                  }`"
                  @click="layoutChange('vertical')"
                >
                  <svg
                    v-if="verticalImage == 'vertical'"
                    width="244"
                    height="150"
                    viewBox="0 0 244 150"
                    fill="none"
                  ...
                  <svg
                    v-if="verticalImage == 'vertical-mini'"
                    width="244"
                    height="150"
                    viewBox="0 0 244 150"
                    fill="none"
                  ...
                  <svg
                    v-if="verticalImage == 'vertical-collapsed'"
                    width="244"
                    height="150"
                    viewBox="0 0 244 150"
                    fill="none"
                ...
                >
                  <b-col cols="4" style="padding: 0 2px">
                    <div
                      :class="`hp-theme-customizer-container-body-item-svg-other${
                        vertical ? ' active' : ''
                      }`"
                      @click="layoutChange('vertical')"
                    >
                      ...
                      >
                        ...
                        <rect
                          ...
                          fill="#DFE6E9"
                        ></rect>
                        <circle cx="38" cy="13" r="2" fill="#636E72"></circle>
                        <path
                          d="M33.7528 18.2807C32.9591 18.059 32.6126 18.0257 32.6126 18.0257C32.4785 18.0036 31.9531 17.9149 31.2377 17.8928C30.6676 17.8041 30.0751 17.6489 29.6839 17.3275C29.2591 16.9728 28.5437 16.3633 28.2642 16.2192C28.2531 16.2081 28.2419 16.2081 28.2307 16.2081C27.1576 15.4433 25.8497 15 24.4413 15C22.8316 15 21.3672 15.5653 20.227 16.5073C19.9029 16.7512 19.5116 17.0837 19.2434 17.3164C18.8521 17.6489 18.2597 17.793 17.6896 17.8817C16.9742 17.9038 16.4488 18.0036 16.3146 18.0147C16.3146 18.0147 16.0017 18.0479 15.2639 18.2474C14.9397 18.3361 14.9062 18.7794 15.208 18.9235C15.208 18.9235 15.2192 18.9235 15.2192 18.9346C15.6998 19.1673 16.1581 19.5442 16.7282 20.4419C17.4101 21.5059 17.5331 22.182 17.969 23.2017C18.6733 26.1277 21.3002 28.3 24.4301 28.3C27.4482 28.3 29.9969 26.2828 30.8129 23.5231C31.3718 22.315 31.4501 21.6167 32.199 20.4419C32.7691 19.5442 33.2274 19.1673 33.7081 18.9346C33.7416 18.9235 33.7751 18.9013 33.8087 18.8902C34.0881 18.7683 34.0546 18.3582 33.7528 18.2807ZM21.8814 23.4012C20.9872 23.1573 20.4283 22.3372 20.4283 22.3372C20.4283 22.3372 21.3896 21.6389 22.2839 21.8827C23.1781 22.1266 23.67 23.2127 23.67 23.2127C23.67 23.2127 22.7757 23.645 21.8814 23.4012ZM27.2023 23.4012C26.308 23.645 25.4138 23.2017 25.4138 23.2017C25.4138 23.2017 25.8944 22.1155 26.7999 21.8717C27.6942 21.6278 28.6555 22.3261 28.6555 22.3261C28.6555 22.3261 28.0966 23.1684 27.2023 23.4012Z"
                          fill="#B2BEC3"
                        ></path>
                  ...
                  <b-col cols="4" style="padding: 0 2px">
                    <div
                      ...
                      @click="layoutChange('vertical-mini')"
                    >
                      <svg
                        width="244"
                        height="150"
                      ...
                      >
                        ...
                        <rect
                          ...
                          fill="#F0F3F5"
                        ></rect>
                        <circle cx="31" cy="13" r="2" fill="#636E72"></circle>
                        <rect width="244" height="150" stroke="#2D3436"></rect>
                      </svg>
                    </div>
                  </b-col>
                  ...
                  <b-col cols="4" style="padding: 0 2px">
                    <div
                      :class="`hp-theme-customizer-container-body-item-svg-other${
                        !verticalCollapsed ? ' active' : ''
                      }`"
                      @click="layoutChange('vertical-collapsed')"
                    >
                      <svg
                        width="244"
                        height="150"
              ...
              <b-col cols="12" md="6" class="mt-24 mt-md-0">
                <div
                  :class="`hp-theme-customizer-container-body-item-svg${
                    horizontal || horizontalFull || horizontalBg
                      ? ' active'
                      : ''
                  }`"
                  @click="layoutChange('horizontal')"
                >
                  <svg
                    v-if="horizontalImage == 'horizontal'"
                    width="244"
                    height="150"
                    viewBox="0 0 244 150"
                    fill="none"
                  ...
                  <svg
                    v-if="horizontalImage == 'horizontal-full'"
                    width="244"
                    height="150"
                    viewBox="0 0 244 150"
                    fill="none"
                  ...
                  <svg
                    v-if="horizontalImage == 'horizontal-bg'"
                    width="244"
                    height="150"
                    viewBox="0 0 244 150"
                    fill="none"
                ...
                >
                  ...
                  <b-col cols="4" style="padding: 0 2px">
                    <div
                      :class="`hp-theme-customizer-container-body-item-svg-other${
                        horizontalFull ? ' active' : ''
                      }`"
                      @click="layoutChange('horizontal-full')"
                    >
                      <svg
                        width="244"
                        height="150"
                  ...
                  <b-col cols="4" style="padding: 0 2px">
                    <div
                      ...
                      @click="layoutChange('horizontal-bg')"
                    >
                      <svg
                        width="244"
                        height="150"
...
export default {
  data() {
    return {
      ...
      vertical: this.$store.state.themeConfig.layout == "vertical" ? true : false,
      ...
      horizontal: this.$store.state.themeConfig.layout == "horizontal" ? true : false,
  ...
  methods: {
    ...
    layoutChange(layout) {
      ...
      if (layout == "vertical") {
        ...
        this.verticalCollapsed = true;

        this.verticalImage = "vertical";

        this.horizontalBg = false;
        this.horizontal = false;
        this.horizontalFull = false;
      ...
      if (layout == "vertical-mini") {
        ...
        this.verticalMini = true;
        this.verticalCollapsed = true;
        this.vertical = false;

        this.verticalImage = "vertical-mini";
      ...
      if (layout == "vertical-collapsed") {
        ...
        this.verticalCollapsed = false;
        this.verticalMini = false;
        this.vertical = false;

        this.verticalImage = "vertical-collapsed";
      ...
      if (layout == "horizontal") {
        ...
        this.horizontalImage = "horizontal";
      ...
      if (layout == "horizontal-full") {
        ...
        this.horizontalFull = true;
        this.horizontal = false;
        this.horizontalBg = false;

        this.horizontalImage = "horizontal-full";
      ...
      if (layout == "horizontal-bg") {
        ...
        this.horizontalBg = true;
        this.horizontal = false;
        this.horizontalFull = false;

        this.horizontalImage = "horizontal-bg";
