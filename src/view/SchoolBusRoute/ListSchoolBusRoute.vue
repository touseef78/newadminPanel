        ...
        <b-row>
            <div class="col-12 mt-16">
              ...
              " class="bi bi-eye" viewBox="0 0 16 16">
                        ...
                        <!-- <b-button @click="zonedetail(row.item.id)" variant="primary" class="btn-sm mb-8 mr-2">
                            Zone Details
                        </b-button> -->
                        <!-- ...... -->
...
export default {
    data() {
        return {
            ...
            fields: [
                ...
                { key: "pickup_name", sortable: true },
                { key: "drop_name", sortable: true },
                // { key: "car_type", sortable: true },
    ...
    methods: {
        ...
        editUser(userId) {
            this.$router.push({ name: "EditSchoolBusRoute", params: { id: userId } });
        },

        showDrivers(userId) {
            this.$router.push({ name: "ViewSchoolBusRoute", params: { id: userId } });
        },
        ///  delete
        ...
        deleteItem(itemId) {
            ...
            axios
                .delete(`pickupPointsDelete/${itemId}`)
                .then((response) => {
