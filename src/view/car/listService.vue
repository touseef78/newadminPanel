                ...
                <b-table id="dataTable" :items="users" :fields="fields" :current-page="currentPage" :per-page="perPage"
                    ...
                    <template #cell(image)="row">
                        <div>
                            ...
                            <b-button @click="downloadImage(row.item.image)" variant="success" class="mt-2">
                                View Image
                            </b-button>
                        </div>
                    </template>
            ...
            >
                        ...
                        <b-modal v-model="isCardModalVisible" title="Select Card Option">
                            <div>
                                ...
                                <b-button @click="updateCardOption" variant="primary">Save</b-button>
                            </div>
                        </b-modal>
                    </template>
...
export default {
    ...
    methods: {
        ...
        fetchData(userId) {
            ...
            axios
                .get(`service/${userId}`) // Replace with your actual API URL
                .then((response) => {
