                            ...
                            <div class="col-md-4 col-12">
                                <b-form-group id="input-group-2" label="Midpoint Location:">
                                    <div v-for="(mid_name, index) in mid_names" :key="index"
                                        ...
                                        <b-form-input :id="'mid_name-' + index" type="text"
                                            placeholder="Enter midpoint location" v-model="mid_name.value"
                                ...
                                <div class="row">
                                    <!-- <div class="col-md-4 col-12">
                                        <b-form-group id="input-group-2" label="Select Car:" label-for="vehicle_id">
                                            <b-form-select id="vehicle_id" placeholder="Select car"
                                                v-model="zone.vehicles.id" disabled>
                                                <option value="">{{ zone.vehicles.name }}</option>
                                            </b-form-select>
                                        </b-form-group>
                                    </div> -->
                                    <div class="col-md-4 col-12">
    ...
    created() {
        ...
        axios
            ...
            .then((response) => {
                ...
                this.mid_name = this.editedUser.mid_name;
