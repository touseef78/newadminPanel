                ...
                ">
                  ...
                  ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <b-form-group id="input-group-2" label="Zone Title:" label-for="name">
                                        <b-form-input id="name" type="name" placeholder="Enter zone title "
                                ...
                                <div class="position-relative col-md-4 col-12">
                                    <b-form-group id="input-group-1" label="Pickup Location:"
                                        label-for="zone_pickup_name">
                                        <b-form-input id="zone_pickup_name" type="text"
                                            placeholder="Enter pickup location" autocomplete="off"
                                            v-model="zone_pickup_name" @change="geocodeAddress"
                                            @input="getLocationSuggestions" @keydown.down.prevent="moveDown"
                                            @keydown.up.prevent="moveUp"
                                            @keydown.enter.prevent="selectHighlightedLocation" disabled>
                                        </b-form-input>
                                ...
                                <div class="col-md-4 col-12">
                                    <b-form-group id="input-group-2" label="Dropoff Location:" label-for="schools_id">
                                        <b-form-input id="schools_id" placeholder="Dropoff location"
                                            v-model="schools_id" disabled></b-form-input>
                                    </b-form-group>
                                </div>
                        ...
                        ">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-12">
                                    <b-form-group :id="input - group - 2" :label="'Car Name ' + (index + 1) + ':'"
                                        :label-for="vehicle_id">
                                        <b-form-input :id="'vehicle_id_' + index" placeholder="Car name"
                                            v-model="vehicle_id_" disabled></b-form-input>
                                    </b-form-group>
                                </div>
