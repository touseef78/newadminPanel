        ...
        <div class="row">
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label="Transaction Id:" label-for="transaction_id">
                  <b-form-input id="transaction_id" type="text" placeholder="Enter transaction id"
                    v-model="transaction_id" required
                    ></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-2" label="Booking No:" label-for="booking_no">
                  <b-form-input id="booking_no" type="text" placeholder="Enter booking_no"
                    v-model="booking_no" required
                    ></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label=" Captain Name:" label-for="captain_name">
                  <b-form-input id="captain_name" type="text" placeholder="Enter captain_name "
                    v-model="captain_name" required></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label="Vehicle Class" label-for="vehicle_class">
                  <b-form-input id="vehicle_class" type="text" placeholder="Enter vehicle class"
                    v-model="vehicle_class" required></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label=" Vehicle No" label-for="vehicle_no">
                  <b-form-input id="vehicle_no" type="text" placeholder="Enter vehicle no"
                    v-model="vehicle_no" required></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label=" Customer Name" label-for="customer_name">
                  <b-form-input id="customer_name" type="text" placeholder="Enter customer name "
                    v-model="customer_name" required></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
              ...
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label="Drop Location" label-for="drop_location">
                  <b-form-input id="drop_location" type="text" placeholder="Enter drop location"
              ...
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label="Amount" label-for="amount">
                  <b-form-input id="amount" type="text" placeholder="Enter amount "
                    v-model="amount" required ></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label="Kilometer" label-for="kilometer">
                  <b-form-input id="kilometer" type="text" placeholder="Enter kilometer"
                    v-model="kilometer" required></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-6 col-12">
                <b-form-group id="input-group-1" label="Day Status" label-for="day_status">
                  <b-form-input id="day_status" type="text" placeholder="Enter day_status"
                    v-model="day_status" required></b-form-input>
                </b-form-group>
              </div>
            </div>
