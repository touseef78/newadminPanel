        ...
        <b-row>
            <div class="col-12 mt-16">
                <b-table id="dataTable" :items="users" :fields="fields" :current-page="currentPage" :per-page="perPage"
                    ...
                    <!-- Other  Expense code here  -->
                    <template #cell(other_expense)="row">

                        {{ `${row.item.type}` }}
                    </template>
                    <!-- Other  Expense code ended here  -->
    ...
    data() {
        return {
            ...
            fields: [
                ...
                { key: "fuel_expense", sortable: true },
                { key: "other_expense", sortable: true },
