                ...
                <b-table :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" responsive="sm">
                    ...
                    <template #cell(actions)="row">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            style="color: rgba(0, 255, 195, 0.87);margin-left:6px; margin-bottom:10px;" class="bi bi-eye" viewBox="0 0 16 16">
                            <path
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            style="color: red; margin-left:12px;margin-bottom:10px;" class="bi bi-trash3" viewBox="0 0 16 16">
                            <path
...
export default {
    data() {
        return {
            ...
            items: [
                { isActive: true, name: 'Ali', mobile: '098765', email: 'ali@gmail.com', reference_name: 'Hannan', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty', status: 'pending' },
                { isActive: true, name: 'Ayyan', mobile: '098765', email: 'ayyan@gmail.com', reference_name: 'Ali', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty', status: 'approved' },
                { isActive: true, name: 'Abbas', mobile: '098765', email: 'abbas@gmail.com', reference_name: 'Musa', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty', status: 'pending' },
                { isActive: true, name: 'Usman', mobile: '098765', email: 'usama@gmail.com', reference_name: 'Usama', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty', status: 'approved' },
