    ...
    <b-card>
        ...
        <b-row>
            <div class="col-12 mt-16">
                <b-table :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" responsive>
                    <!-- Action Button Code -->
                    <template #cell(actions)="row">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            style="color: rgba(0, 255, 195, 0.87);margin-left:6px; margin-bottom:10px;" class="bi bi-eye"
                            viewBox="0 0 16 16">
                            <path
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                            style="color: red; margin-left:12px;margin-bottom:10px;" class="bi bi-trash3"
                            viewBox="0 0 16 16">
                            <path
...
export default {
    data() {
        return {
            ...
            items: [
                { isActive: true, name: 'Ali', mobile: '098765', email: 'ali@gmail.com', reference_name: 'Hannan', reference_number: '098467', CNIC: '35201-9876543-1', status: 'pending' },
