            ...
            <div class="col-12 mt-16">
                <b-table :items="items" :fields="fields" :sort-by.sync="sortBy" :sort-desc.sync="sortDesc" responsive="sm">
                    ...
                    <template #cell(actions)="row">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            style="color: red; margin-right:10px;" class="bi bi-trash3" viewBox="0 0 16 16">
                            <path
...
export default {
    data() {
        return {
            ...
            items: [
                { isActive: true, name: 'Ali', mobile: '098765', email: 'ali@gmail.com', reference_name: 'Hannan', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty',section:'pending' },
                { isActive: true, name: 'Ayyan', mobile: '098765', email: 'ali@gmail.com', reference_name: 'Ali', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty' ,section: 'approved' },
                { isActive: true, name: 'Abbas', mobile: '098765', email: 'ali@gmail.com', reference_name: 'Musa', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty', section: 'pending' },
                { isActive: true, name: 'Usman', mobile: '098765', email: 'ali@gmail.com', reference_name: 'Usama', reference_number: '098467', CNIC: '35201-9876543-1', selection: 'empty', section: 'approvedpp' },
