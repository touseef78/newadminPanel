            ...
            <div class="row">
              ...
              <div class="col-md-4 col-12">
                <b-form-group id="input-group-2" label="Password:" label-for="password">
                  <b-form-input id="password" type="password" placeholder="Enter Password" v-model="password"></b-form-input>
                </b-form-group>
              </div>
              <div class="col-md-4 col-12">
              ...
              <div v-if="selectedCarType === 'Own'">
                <b-row>
                  <div class="col-12 mt-16">
                    ...
                    <div class="col-md-4 col-12">
                      <b-form-group id="input-group-1" label="Vehicle Documents:" label-for="vehicle_image">
