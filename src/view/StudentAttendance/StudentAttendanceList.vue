            ...
            <div class="col-12 mt-16">
                <b-table id="dataTable" :items="users" :fields="fields" :current-page="currentPage" :per-page="perPage"
                    ...
                    <template #cell(actions)="row">
                        ...
                        <b-button @click="detailsChilds(row.item.student_id)" variant="primary"
                            class="mb-8 mr-8">Student
                            Detail
                        </b-button>
...
export default {
    ...
    methods: {
        fetchData() {
            ...
            const apiUrl = "studentAttendance";
        ...
        detailsChilds(userId) {
            this.$router.push({ name: "StudentAttendanceView", params: { id: userId } });
        },
    },
};
</script>